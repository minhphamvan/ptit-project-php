<div class="left">
                    ...
                    <div class="left__content">
                        <div class="left__logo">QUẢN LÝ TRƯỜNG HỌC</div>
                        <div class="left__profile">
                            <div class="left__image">
                                <a href="dashboard.html"><img src="Views/admin/images/avatar.png" alt=""></a>
                            </div>

                            <a href="thong-tin-nguoi-dung.html">
                                <p class="left__name">Minh Pham</p>
                            </a>
                        </div>

                        <ul class="left__menu">
                            <li class="left__menuItem">
                                <a href="dashboard.html" class="left__title"><img src="Views/admin/assets/icon-dashboard.svg" alt="">Bảng điều khiển</a>
                            </li>

                            <li class="left__menuItem">
                                <a href="/ptit-project-php/index.php?controller=user&action=details&id=1" class="left__title"><img src="Views/admin/assets/icon-pencil.svg" alt="">Sinh nhật hôm nay</a>
                            </li>
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    ...
                                    <a class="left__link" href="xem-tat-ca-khoa.html">Xem tất cả</a>
                                </div>
                            </li>
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    <a class="left__link" href="#">Thêm ngành</a>
                                    <a class="left__link" href="#">Xem tất cả</a>
                                </div>
                            </li>
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    <a class="left__link" href="#">Thêm sinh viên</a>
                                    <a class="left__link" href="#">Xem tất cả</a>
                                </div>
                            </li>
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    <a class="left__link" href="#">Thêm môn học</a>
                                    <a class="left__link" href="#">Xem tất cả</a>
                                </div>
                            </li>

                            <li class="left__menuItem">
                                <a href="/ptit-project-php/index.php?controller=user&action=details&id=1" class="left__title"><img src="Views/admin/assets/icon-settings.svg" alt="">Thông tin tài khoản</a>
                            </li>

                            <li class="left__menuItem">
                                <a href="/index.html" class="left__title"><img src="Views/admin/assets/icon-logout.svg" alt="">Đăng Xuất</a>
                            </li>
                        </ul>
                    </div>
                </div>
